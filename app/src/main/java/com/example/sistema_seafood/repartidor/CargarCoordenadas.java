...
public class CargarCoordenadas extends AsyncTask<String, Void, String> {
    ...
    String latitudInicial,latitudFinal,longitudInicial,longitudFinal;


    public CargarCoordenadas(AsyncResponse delegate) {
    ...
    protected void onPostExecute(String result) {
        delegate.processFinish(result); // This sends the result back to the calling activity
    }
