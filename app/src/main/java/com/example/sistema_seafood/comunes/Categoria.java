    ...
    public List<Platillo> getPlatillos(){
        if(platillos==null){
            ...
            for(Map map:(ArrayList<Map>)documentReference.get("platillos")){
                platillos.add(new Platillo(map.get("nombre").toString(),
                        map.get("descripcion").toString(),
                        Double.parseDouble(map.get("precio").toString()),
                        Double.parseDouble(map.get("descuento").toString()),
                        new ArrayList<>(),
                        Double.parseDouble(map.get("puntuacion").toString())));
            }
        }
        return platillos;
    }
